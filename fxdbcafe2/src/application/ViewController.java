...
public class ViewController {
    ...
    void onClickDate(ActionEvent event) throws SQLException {
		 ...
		 *         ObservableList<Data> list = FXCollections.observableArrayList(
                new PieChart.Data("total_coffee", total_coffee),    
                new PieChart.Data("total_cake", total_cake),
                new PieChart.Data("total", total),
                new PieChart.Data("subtotal", subtotal),
                new PieChart.Data("tax", tax),
                new PieChart.Data("service", service)
                );
            pie.setData(list);
		 */
